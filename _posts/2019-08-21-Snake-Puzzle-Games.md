...
><font size="2">After we decided on the key mechanism, we first added the fundamental element, which make the snake grow one grid after it eats. This is something common to all snake games - I call it 'rat/mouse'. Now, we consider what the next element would be.<br></font>
