...
As a final note, I will aim to answer the age-old question: Can a snake move into its own tail?  The answer, as given by the applicable games above, is no! (by a count of 16 to 10)  I do suspect that part of this is due to the slight nuisance of programming it. Interestingly, in Snakebird there is a [bug](https://twitter.com/nohatcoder/status/621282209224368128) whereby a snake cannot normally move into its tail, but it *can* move another object into its tail.  The reverse situation is present in Snake Slider, where a snake can normally move into its tail, but *cannot* push a different object into its tail.
