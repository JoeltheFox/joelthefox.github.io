...
If you cannot live without knowing, if you, a veritable *bon vivant*, would be incapacitated with uncertainty, unable to even prod your frosty potatoes when the microwave displays "flip," a shadow of yourself with bags under your eyes and ears, simply going through the motions until the day comes when you are not *alive* enough to care about serpentine lore, if you find yourself in such execrable circumstancse I believe there is one way out: you must enter a parallel universe where snakes play games about humans, and determine whether their ENIGMASH has humans in it by consulting the eminent snake authority on human puzzle games<sup>†</sup>. You might protest - "but such a universe cannot exist, an *intelligent* snake investing itself in frivolous human puzzle games is a contradiction!" Actually you're right, I hadn't thought of that. Still, we can surmise that if humans did appear in TRANSUNIVERSALENIGMASH, they would probably have the ability to decompose into their component blocks, which can then be rearranged and recombined.
  
<font size="2"><sup>†</sup>Liability waiver: by reading this article you agree to take all responsibility for risks associated with interdimensional space travel including but not limited to being trapped in an infinite loop</font>
