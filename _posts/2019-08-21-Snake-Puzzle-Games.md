...
Looking at a tiny grid of snakes, you would expect that getting one snake to the other end would either be very easy or it would be impossible, so it is quite charming to see the solutions unfold in an intricate, and sometimes unnatural, way. Especially amusing is when you start down a path of several clearly forced moves before finding yourself... stuck? The puzzles are grouped into 4 sets by the number of snakes that they have. Andrea recommends the 2-snake and 3-snake sets, and I think I would add in the 4-snake set too. The single snake set is a bit funny, you'll see why if you go through a few of them.  
